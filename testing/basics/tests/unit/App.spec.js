...
describe('App.vue', () => {
  ...
  it("should render correct contents", () => {
    ...
    expect(wrapper.html()).to.contain('<input type="text" class="prompt" placeholder="Add item...">');
    expect(wrapper.html()).to.contain('<button type="submit" class="ui button" disabled="">Add</button>');
  ...
  describe("the user populates the text input field", () => {
    ...
    it('it should update the "text" data property', () => {
